...
class IapApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [IapValidateResponse] as data
  ...
  Future<Response<IapValidateResponse>> iapValidatePost({ 
    ...
    try {
      const _type = FullType(IapValidateRequest);
      _bodyData = _serializers.serialize(iapValidateRequest, specifiedType: _type);
    ...
    IapValidateResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(IapValidateResponse),
      ) as IapValidateResponse;
