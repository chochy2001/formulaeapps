...
class ChatApi {
  ...
  /// Proxy a chat completion through OpenRouter
  /// Verifies the JWT, assembles the chat request server-side (system prompts live in bff/src/schemas/prompts.ts), forwards to OpenRouter, returns the response. Routing via OpenRouter lets the FE switch models per task and adopt new ones without a BFF redeploy.
  ///
  /// Parameters:
  /// * [chatRequest] 
  ...
  Future<Response<ChatResponse>> openaiChatPost({ 
