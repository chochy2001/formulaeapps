...
class ExponencialyLogaritmoIntegral extends StatefulWidget {
  ...
  ExponencialyLogaritmoIntegralState createState() =>
      ExponencialyLogaritmoIntegralState();
}

class ExponencialyLogaritmoIntegralState
        ...
        child: SafeArea(
          child: ListView(
            children: [
              ...
              const ZoomPersonalizado(
                child: Column(
                  children: [
                    ...
                    SizedBox(height: kEspacioEntreBotones),
                    Latex(
                      formulaText: r"\int a^u\space du = \frac{a^u}{ln|a|}+C",
                    ),
                    SizedBox(height: kEspacioEntreBotones),
                    Latex(
                      formulaText:
              ...
              const Column(
                children: [
                  VerPDF(url: kWidgetExponencialLogaritmoIntegral),
                  //Descargar PDF
                  DescargarPDF(url: kWidgetExponencialLogaritmoIntegral),
                ],
              ),
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    const SizedBox(height: kEspacioEntreBotones),
                    const Latex(
                      formulaText: r"ln(x) = \int_1 ^x \frac{dt}{t},\space x>0",
                    ),
                    const SizedBox(height: kEspacioEntreBotones),
                    TextoEcuaciones(
