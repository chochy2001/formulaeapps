...
class TrigonometricasInversasIntegral extends StatefulWidget {
  const TrigonometricasInversasIntegral({super.key});

  @override
  TrigonometricasInversasIntegralState createState() =>
      TrigonometricasInversasIntegralState();
}

class TrigonometricasInversasIntegralState
        ...
        child: SafeArea(
          child: ListView(
            children: [
              ...
              const Column(
                children: [
                  VerPDF(url: kWidgetTrigonometricasInversasIntegral),
                  //Descargar PDF
                  DescargarPDF(url: kWidgetTrigonometricasInversasIntegral),
                ],
              ),
