...
class FuncionesTrigonometricasIntegral extends StatefulWidget {
  ...
  FuncionesTrigonometricasIntegralState createState() =>
      FuncionesTrigonometricasIntegralState();
}

class FuncionesTrigonometricasIntegralState
        ...
        child: SafeArea(
          child: ListView(
            children: [
              ...
              const Column(
                children: [
                  VerPDF(url: kWidgetFuncionesTrigonometricasIntegral),
                  //Descargar PDF
                  DescargarPDF(url: kWidgetFuncionesTrigonometricasIntegral),
                ],
              ),
