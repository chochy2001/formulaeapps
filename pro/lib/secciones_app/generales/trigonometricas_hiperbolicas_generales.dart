...
class TrigonometricasHiperbolicasGenerales extends StatefulWidget {
  const TrigonometricasHiperbolicasGenerales({Key? key}) : super(key: key);

  @override
  TrigonometricasHiperbolicasGeneralesState createState() =>
      TrigonometricasHiperbolicasGeneralesState();
}

class TrigonometricasHiperbolicasGeneralesState
