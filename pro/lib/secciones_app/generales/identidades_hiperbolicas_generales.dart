...
class IdentidadesHiperbolicasGenerales extends StatefulWidget {
  const IdentidadesHiperbolicasGenerales({Key? key}) : super(key: key);

  @override
  IdentidadesHiperbolicasGeneralesState createState() =>
      IdentidadesHiperbolicasGeneralesState();
}

class IdentidadesHiperbolicasGeneralesState
