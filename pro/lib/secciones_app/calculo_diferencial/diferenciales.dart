            ...
            const ZoomPersonalizado(
              child: Column(
                children: [
                  ...
                  Latex(formulaText: r"\frac{df}{dx} = \lim_{h \to 0} \frac{f(x+h)-f(x)}{h} = \lim_{\Delta x \to 0} \frac{f(x+\Delta x)-f(x)}{\Delta x}"),
                  SizedBox(height: kEspacioEntreBotones),
                  Latex(formulaText: r"d\!\left(\frac{u}{v}\right) = \frac{v\,du - u\,dv}{v^{2}}"),
                  SizedBox(height: kEspacioEntreBotones),
                  Latex(formulaText: r"d\!\left(\frac{c}{u}\right) = -\frac{c}{u^{2}}\,du"),
                  SizedBox(height: kEspacioEntreBotones),
                  Latex(formulaText: r"d\!\left(\frac{u}{c}\right) = \frac{du}{c}"),
                  SizedBox(height: kEspacioEntreBotones),
                  Latex(formulaText: r"d\sqrt{u} = \frac{du}{2\sqrt{u}}"),
                  SizedBox(height: kEspacioEntreBotones),
                  Latex(formulaText: r"d\!\left(\sqrt[n]{u^{m}}\right) = \frac{m\,du}{n\,\sqrt[n]{u^{\,n-m}}}"),
                  SizedBox(height: kEspacioEntreBotones),
                  Latex(formulaText: r"d(|v|) = \frac{v}{|v|}\,dv"),
                  SizedBox(height: kEspacioEntreBotones),
                  Latex(formulaText: r"d(\operatorname{sen} u) = \cos u \cdot du"),
                  SizedBox(height: kEspacioEntreBotones),
                  Latex(formulaText: r"d(\cos u) = -\operatorname{sen} u \cdot du"),
                  SizedBox(height: kEspacioEntreBotones),
                  Latex(formulaText: r"d(\tan u) = \sec^{2} u \cdot du"),
                  SizedBox(height: kEspacioEntreBotones),
                  Latex(formulaText: r"d(\operatorname{arc\,sen} u) = \frac{du}{\sqrt{1-u^{2}}}"),
                  SizedBox(height: kEspacioEntreBotones),
                  Latex(formulaText: r"d(\operatorname{arc\,tan} u) = \frac{du}{1+u^{2}}"),
                  SizedBox(height: kEspacioEntreBotones),
