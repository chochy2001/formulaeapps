...
class ElipseConCentroEnElOrigen extends StatefulWidget {
  ...
  ElipseConCentroEnElOrigenState createState() =>
      ElipseConCentroEnElOrigenState();
}

class ElipseConCentroEnElOrigenState extends State<ElipseConCentroEnElOrigen> {
  @override
            ...
            Center(
              child: Column(
                ...
                children: [
                  ...
                  ZoomPersonalizado(
                    child: Column(
                      children: [
                        ...
                        const Latex(
                          formulaText: r"\frac{x^2}{a^2}+\frac{y^2}{b^2} = 1",
                        ),
                        const SizedBox(height: kEspacioEntreBotones),
                        const Latex(
                          formulaText:
                        ...
                        const SizedBox(height: kEspacioEntreBotones),
                        const Latex(
                          formulaText: r"\frac{x^2}{b^2}+\frac{y^2}{a^2} = 1",
                        ),
                        const SizedBox(height: kEspacioEntreBotones),
                        const Latex(
                          formulaText:
                  ...
                  const VerPDF(url: kWidgetElipseConCentroEnElOrigen),
                  //Descargar PDF
                  const DescargarPDF(url: kWidgetElipseConCentroEnElOrigen),
                ],
              ),
            ),
          ],
