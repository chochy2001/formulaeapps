...
void main() {
  ...
  test('postHogAppPropertyPro is the fleet-lock Formulae Pro tag', () {
    expect(postHogAppPropertyPro, 'formulae-pro');
  });

  test('postHogAppPropertyCommunity is the fleet-lock Formulae Community tag',
      () {
    expect(postHogAppPropertyCommunity, 'formulae-community');
  });
}
