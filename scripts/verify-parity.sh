...
# (pubspec.yaml, lib/, analysis_options.yaml). These are produced by the
# version-pinned toolchain (@hono/zod-openapi + openapi-generator) and are
# byte-reproducible. README files are regenerated and guarded against dead links
# by generate-bff-types.sh, but do not define the API serialization contract.
#
...
PATHS=(
  "contracts"
  "pro/packages/formulaeapps_bff_client/pubspec.yaml"
  "pro/packages/formulaeapps_bff_client/analysis_options.yaml"
  "pro/packages/formulaeapps_bff_client/lib"
  "community/packages/formulaeapps_bff_client/pubspec.yaml"
  "community/packages/formulaeapps_bff_client/analysis_options.yaml"
  "community/packages/formulaeapps_bff_client/lib"
)
