...
import 'package:formulaeapps_bff_client/src/auth/api_key_auth.dart';
import 'package:formulaeapps_bff_client/src/auth/basic_auth.dart';
import 'package:formulaeapps_bff_client/src/auth/bearer_auth.dart';
...
class FormulaeappsBffClient {
  static const String basePath = r'https://api.formulaeapps.com';

  final Dio dio;
  final Serializers serializers;

  FormulaeappsBffClient({
    Dio? dio,
  ...
  /// Get IapApi instance, base route and serializer can be overridden by a given but be careful,
  /// by doing that all interceptors will not be executed
  IapApi getIapApi() {
    return IapApi(dio, serializers);
  }
}
