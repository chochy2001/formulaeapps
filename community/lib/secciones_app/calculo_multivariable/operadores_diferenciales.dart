      ...
      body: SafeArea(
        child: ListView(
          children: [
            ...
            ZoomPersonalizado(
              child: Column(
                children: [
                  ...
                  const SizedBox(height: kEspacioEntreBotones),
                  TextoEcuaciones(AppLocalizations.of(context)!.divergencia),
                  const Latex(
                    formulaText:
                  ...
                  TextoEcuaciones(AppLocalizations.of(context)!.componentesDe),
                  const Latex(formulaText: r"\vec{F}"),
                  const SizedBox(height: kEspacioEntreBotones),
                  const SizedBox(height: kEspacioEntreBotones),
                  TextoEcuaciones(AppLocalizations.of(context)!.rotacional),
                  ...
                  const SizedBox(height: kEspacioEntreBotones),
                  const SizedBox(height: kEspacioEntreBotones),
                  TextoEcuaciones(AppLocalizations.of(context)!.laplaciano),
                  const SizedBox(height: kEspacioEntreBotones),
                  const Latex(formulaText: r"f"),
                  TextoEcuaciones(AppLocalizations.of(context)!.funcionEscalar),
                  const SizedBox(height: kEspacioEntreBotones),
                  const Latex(
                    formulaText:
            ...
            const VerPDF(url: kWidgetOperadoresDiferenciales),
            //Descargar PDF
            const DescargarPDF(url: kWidgetOperadoresDiferenciales),
            const SizedBox(height: 20.0),
          ],
        ),
      ),
