...
class TrigonometricasInversasIntegral extends StatefulWidget {
  ...
  @override
  State<TrigonometricasInversasIntegral> createState() =>
        ...
        child: SafeArea(
          child: ListView(
            children: [
              ...
              const VerPDF(url: kWidgetTrigonometricasInversasIntegral),
              //Descargar PDF
              const DescargarPDF(url: kWidgetTrigonometricasInversasIntegral),
