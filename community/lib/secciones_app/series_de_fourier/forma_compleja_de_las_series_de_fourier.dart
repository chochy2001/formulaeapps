...
class FormaComplejaDeLasSeriesDeFourier extends StatefulWidget {
  const FormaComplejaDeLasSeriesDeFourier({super.key});
  @override
  State<FormaComplejaDeLasSeriesDeFourier> createState() =>
            ...
            Center(
              child: Column(
                ...
                children: [
                    ...
                    builder: (context, favoritesNotifier, child) {
                      bool isFavorite = favoritesNotifier.isFavorite(
                        Favorite(
                          ...
                          widgetName: kWidgetFormaComplejaDeLasSeriesDeFourier,
                        ),
                      );
                      return IconButton(
                        icon: isFavorite
                  ...
                  ZoomPersonalizado(
                    child: Column(
                      children: [
                        ...
                        const SizedBox(height: kEspacioEntreBotones),
                        const SizedBox(height: kEspacioEntreBotones),
                        TextoEcuaciones(AppLocalizations.of(context)!.teniendo),
                        const SizedBox(height: kEspacioEntreBotones),
                        ...
                        const SizedBox(height: kEspacioEntreBotones),
                        const Latex(
                          formulaText: r"|c_n| = \frac{1}{2}\sqrt{a_n^2+b_n^2}",
                        ),
                        const SizedBox(height: kEspacioEntreBotones),
                        const Latex(
                          formulaText:
                  ...
                  const VerPDF(url: kWidgetFormaComplejaDeLasSeriesDeFourier),
                  //Descargar PDF
                  const DescargarPDF(
