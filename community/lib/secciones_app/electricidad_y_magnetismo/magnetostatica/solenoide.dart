  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: ListView(
          children: [
            TituloPersonalizado(AppLocalizations.of(context)!.solenoide),
            adContainer,
            ...
            Column(
              children: <Widget>[
                ...
                TextoEcuaciones(AppLocalizations.of(context)!.solenoideBobina),
                const SizedBox(height: 30.0),
                ...
                const SizedBox(height: 20.0),
                TextoEcuaciones(AppLocalizations.of(context)!.paraUnaPosicionD),
                const SizedBox(height: 20.0),
                const Latex(
                  formulaText:
                ...
                const SizedBox(height: 20.0),
                TextoEcuaciones(AppLocalizations.of(context)!.solenoideIdeal),
                const SizedBox(height: 20.0),
            ...
            const VerPDF(url: kWidgetSolenoide),
            //Descargar PDF
            const DescargarPDF(url: kWidgetSolenoide),
          ],
        ),
      ),
    );
