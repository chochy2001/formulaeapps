  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: ListView(
          children: [
            TituloPersonalizado(AppLocalizations.of(context)!.inductanciaMutua),
            adContainer,
            ...
            const VerPDF(url: kWidgetInductanciaMutua),
            //Descargar PDF
            const DescargarPDF(url: kWidgetInductanciaMutua),
          ],
        ),
      ),
    );
